...
public class CreditsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        creditList.add(new Credits("Facebook Logo Picture", fbAuthor, fbLogoDesc, "https://ru-ru.facebook.com/"));
        creditList.add(new Credits("Twitter Logo Picture", twitterAuthor, twitterLogoDesc, "https://twitter.com/?lang=ru"));
